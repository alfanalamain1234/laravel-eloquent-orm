                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <img class="h-10 w-10 rounded-full" src="{{optional(optional($item->match_rivals)->rivals)->logo}}" alt="">
                                        </div>
                                        <div class="ml-4">
                                            <div class="text-sm font-medium t ext-gray-900"> 
                                                {{optional(optional($item->match_rivals)->rivals)->name}}
                                            </div>
                                            <div class="text-sm text-gray-500">
                                                {{optional(optional($item->match_rivals)->rivals)->url}}
                                            </div>
                                        </div>
                                    </div>
                                </td>
